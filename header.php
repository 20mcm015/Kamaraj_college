...
<html>
    <head>
        <title>kamarajcollege.ac.in</title>
        <link rel="icon" href="https://www.kamarajcollege.ac.in" type="image/x-icon" />
        ...
        <div id="header-wrapper">
            <div class="container">
                <div class="row">
                    <div class="12u">
                        <header id="header">
                            <h1><a href="kamarajcollege.php" id="logo"><?php echo SITE_NAME; ?></a></h1>
                            <nav id="nav">

<a href="w.html" <?php echo ($currentPage == "index") ? ' class="current-page-item"' : '' ?> >Computer Science</a>
                                <a href="online/index.php" <?php echo ($currentPage == "online") ? ' class="current-page-item"' : '' ?> >Online</a>
